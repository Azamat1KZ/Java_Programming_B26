...
public class Google {
    public static void main(String[] args) {
        WebElement link = new Link(); // created a Link project with WebElement reference
        ...
        WebElement [] allElements = new WebElement[4]; // created an array that will store objects from classes that inplemetn the WebElement interface
        // [null, null, null, null]
