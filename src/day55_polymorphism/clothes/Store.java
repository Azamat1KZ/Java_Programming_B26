...
//        jacket3.wear();
//         jacket3.putOnHood();
        // Object class does not have reference to wear() of putOnHood() methods

        HasHood jacket4 = new Jacket();
        // jacket4.wear();// HasHood reference does not have visibility to wear() or putOnHood() methods
        jacket4.putOnHood();
