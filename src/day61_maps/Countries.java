...
public class Countries {
    public static void main(String[] args) {
        ...
        //Print all cities that start with D ot I

        for (ArrayList<String> cities : countries.values()){ //iterates through the values if the map, which are ArrayList of cities
