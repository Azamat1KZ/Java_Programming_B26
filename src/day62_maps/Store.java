...
//        }
        ...
        }// getValue method is the method from the Entry, which gives value of the current entry
        ...
        System.out.println(store.containsKey(item) ? item + " is in stock for " + store.get(item) : "Item is not available in this store");
        store.get(item);
    }
}
