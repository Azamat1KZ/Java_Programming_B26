...
public class StreamMethods {
    public static void main(String[] args) {
        ...
        // Task: find how many different letters there is (no about duplicates)
        String s = "aaabbbbccccddddeefgggg";
        System.out.println(Arrays.stream(s.split("")).distinct().collect(Collectors.toList())); // could have also done .toArray() instead of collect method
