...
public class StreamsMethods2 {
    public static void main(String[] args) {
        ...
        System.out.println(list.stream().filter(p -> p % 2 == 0).count()); // finding how many uniques numbers there is
        ...
        list3.stream().filter(p -> p % 2 == 0).forEach(System.out::println); //same as previous line
/*
